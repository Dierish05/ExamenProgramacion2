                                                  ...
                                                  bwData = new BinaryWriter(DataStream))
                {
                    ...
                    using (BinaryReader brHeader = new BinaryReader(bwHeader.BaseStream))
                    {
                        ...
                        foreach (PropertyInfo pinfo in info)
                        {
                            ...
                            {
                                bwData.Write((string)obj.ToString());
                            }
                            else if (type.IsClass)
                            {
                                //obj newValue = (obj)Activator.CreateInstance(typeof(obj));
                                //bwData.Write(obj);
                            }
                        }
            ...
            try
            {
                                    ...
                                    brData = new BinaryReader(DataStream))
                {
                    ...
                    foreach (PropertyInfo pinfo in properties)
                    {
                        ...
                        {
                            pinfo.SetValue(newValue, brData.GetValue<DateTime>(TypeCode.DateTime));
                        }
                    }
                    return newValue;
                }
